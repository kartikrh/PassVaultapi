  ...
  try {
    ...
    const result = await fastify.db.query(
      ...
      with insert_data as(
        ...
        "wrEventDate","wrEventName","wrEventRefId","wrTeam1Id","wrTeam2Id","wrLocation","wrWeather","wrPitchCracks","wrDisplayStatus","wrTarget","wrMarketID","wrTpId","isMatchTypeUpdated" , "wrCreatedBy" , "wrCreatedDate","wrCommentaryStatus","wrCurrentInnings", "wrSystemPlayerCount","wrIsPredictMarket",
        ...
        "wrCountryId", "wrVenueId", "wrScoringType"
        ) values (
          $1,
          $2,
          $3,
...
const updateCommentaryQuery = async (request, fastify) => {
  try {
    ...
    return await fastify.db.query(
      ...
      "wrPitchCracks" = $12,
      "wrTarget" = $13 ,
      "isMatchTypeUpdated" = $14,
      "wrIsPredictMarket" = $16, 
      "wrModifyDate" = now(),
      "wrDelay"=$17,
      "wrIsActive" = $18,
      "wrIsClientShow" = $19,
