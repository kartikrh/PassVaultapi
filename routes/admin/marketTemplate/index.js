...
module.exports = async function (fastify, opts) {
  ...
  fastify.post("/defaultIsSendData", {
    schema: MarketTemplate.defaultIsSendData.schema,
    preHandler: [
      (request, reply) => authorize(request, reply, fastify),
      (request, reply) =>
        checkPermission(request, reply, fastify, {
    ...
    handler: (request, reply) => defaultIsSendDataChange(request, reply, fastify),  
  });

  fastify.post("/allMarketTypesAndCategory", {
    preHandler: [
      (request, reply) => authorize(request, reply, fastify),
      // (request, reply) =>
      //   checkPermission(request, reply, fastify, {
    ...
    handler: (request, reply) => allMarketTypesAndCategories(request, reply, fastify),  
  });
  ...
  fastify.post("/cloneMultipleTemp", {
    schema: MarketTemplate.cloneMultipletemplates.schema,
    preHandler: [
      (request, reply) => authorize(request, reply, fastify),
      (request, reply) =>
        checkPermission(request, reply, fastify, {
    ...
    handler: (request, reply) => multiCloneMarketTemplate(request, reply, fastify),  
  });
  fastify.post("/isDefaultSetResult", {
    schema: MarketTemplate.isDefaultSetResultChange.schema,
    preHandler: [
      (request, reply) => authorize(request, reply, fastify),
      (request, reply) =>
        checkPermission(request, reply, fastify, {
    ...
    handler: (request, reply) => isDefaultSetResultChange(request, reply, fastify),  
  });
