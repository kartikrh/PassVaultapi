...
const { getTeamMatchTypeByTeamId, saveTeamMatchTypeByTeamId, updateTeamMatchDataTypeByTeamId, activeInactiveTeamMatchDataTypeByTeamId, deleteTeamMatchTypeByTeamId, getPlayersForTeamMatchTypeByTeamId } = require("../../../controller/users/admin/teamMatchType");
...
module.exports = async (fastify, opts) => {
    ...
    fastify.post("/getPlayers", {
        schema: TeamMatchType.getplayers.schema,
        preHandler: [
            (request, reply) => authorize(request, reply, fastify),
            (request, reply, done) =>
                checkPermission(request, reply, fastify, {
        ...
        handler: (request, reply) => getPlayersForTeamMatchTypeByTeamId(request, reply, fastify),
    });
}