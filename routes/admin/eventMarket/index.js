...
module.exports = async (fastify, opts) => {
    ...
    fastify.post("/socketData", {
        handler: (request, reply) => globalScoketData(request, reply, fastify),
    });
};
