...
module.exports = async (fastify, opts) => {
    ...
    fastify.post("/upSendMarket",{
        schema: EventMarket.upSendMarket.schema,
        preHandler: [
            (request, reply) => authorize(request, reply, fastify),
            (request, reply) => checkPermission(request, reply, fastify, {
                tabName: "Event Markets",
        ...
        handler: (request, reply) => upSendMarketData(request, reply, fastify)
    })
    fastify.post("/delete", {
    ...
    fastify.post("/setIsResult", {
        schema: EventMarket.setIsResult.schema,
        preHandler: [
          (request, reply) => authorize(request, reply, fastify),
          (request, reply, done) =>
            checkPermission(request, reply, fastify, {
        ...
        handler: (request, reply) => changeMultiMarketsIsResult(request, reply, fastify),
    });
};
